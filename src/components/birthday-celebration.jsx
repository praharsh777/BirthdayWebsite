...
export default function BirthdayCelebration() {
  ...
  // Add your image URL or path here
  const imageUrl = '/image.jpg';  // Path relative to the public folder
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">JANU 姉 妹</h3>
      </motion.div>
              ...
              >
                <div className="text-center">
                  <p className="text-purple-700 mb-2">
                    A small Light verse for You
                    <br></br><br></br>
                    You’re tiny in height but big in heart, <br></br>
                    A sweet little tornado, wickedly smart.<br></br>
                    You roast me daily, yet cheer me too—<br></br>
                    Don’t know how I’d survive without you! 😄💕
                  </p>
      ...
      {/* Image pop-up beside the card */}
      <AnimatePresence>
        {isCardOpen && (
          <motion.div
            className="absolute top-16 right-16 w-48 h-48 rounded-full overflow-hidden shadow-2xl"
      ...
      >
        <div className="text-center">
          <p className="text-lg text-purple-700 mb-4">
            May every wish you make today come true—you deserve the world and more.
            You’ve helped me grow without even trying, just by being you. I’ve never had this kind of fun, connection, and comfort with anyone else before. From shared laughs online to little moments that meant the world, you’ve made life lighter and better.
          </p>
